...
class Snake:
    def __init__(self, body=None, head=(0, 4), directions=None, head_direction=3):
    ...
    def move(self, direction):
        ...
        nextp = [(0, -1), (-1, 0), (1, 0), (0, 1)]
        tmp = (self.head[0] + nextp[direction][0], self.head[1] + nextp[direction][1])
